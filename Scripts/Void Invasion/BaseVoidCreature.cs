...
namespace Server.Mobiles
{
	...
	public abstract class BaseVoidCreature : BaseCreature
	{
		public static int m_ActiveVoidCreatures;
		...
		public BaseVoidCreature( AIType ai, FightMode mode, int iRangePerception, int iRangeFight, double dActiveSpeed, double dPassiveSpeed )
		...
		{
			private BaseVoidCreature m_Owner;

			public EvolutionTimer( BaseVoidCreature owner )
	...
	public abstract class EvolutionHandler
	{
		...
		protected BaseVoidCreature Owner { get { return m_Owner; } }
		...
		public EvolutionHandler( BaseVoidCreature owner, Type evolutionType, int requiredPoints )
		{
			m_Owner = owner;
	...
	{
		public KillingPathHandler( BaseVoidCreature owner, Type evolutionType, int requiredPoints )
	...
	public class GroupingPathHandler : EvolutionHandler
	{
		...
		public GroupingPathHandler( BaseVoidCreature owner, Type evolutionType, int requiredPoints )
			: base( owner, evolutionType, requiredPoints )
		{
		}
	...
	{
		public SurvivalPathHandler( BaseVoidCreature owner, Type evolutionType, int requiredPoints )
			: base( owner, evolutionType, requiredPoints )
		{
		}
		...
		public override void OnTick()
		{
			if ( Owner.Combatant != null && Owner.Combatant is Mobile )
			{
				Mobile c = Owner.Combatant as Mobile;
				CurrentPoints += c.Fame / 10;
			}
