...
namespace Server
{
    ...
    public class SkillInfo
    {
        ...
        private static SkillInfo[] m_Table = new SkillInfo[58]
        {
            ...
            new SkillInfo(1, "Anatomy", 0.0, 0.0, 0.0, "Biologist", null, 0.15, 0.15, 0.7, 0.5, StatCode.Int, StatCode.Str),
            ...
            new SkillInfo(17, "Healing", 6.0, 6.0, 8.0, "Healer", null, 0.6, 0.6, 0.8, 0.5, StatCode.Int, StatCode.Dex),
            ...
            new SkillInfo(27, "Tactics", 0.0, 0.0, 0.0, "Tactician", null, 0.0, 0.0, 0.0, 0.25, StatCode.Str, StatCode.Dex),
            ...
            new SkillInfo(31, "Archery", 2.5, 7.5, 0.0, "Archer", null, 0.25, 0.75, 0.0, 0.5, StatCode.Dex, StatCode.Str, true ),
            ...
            new SkillInfo(40, "Swordsmanship", 7.5, 2.5, 0.0, "Swordsman", null, 0.75, 0.25, 0.0, 0.25, StatCode.Str, StatCode.Dex, true ),
            new SkillInfo(41, "Mace Fighting", 9.0, 1.0, 0.0, "Armsman", null, 0.9, 0.1, 0.0, 0.25, StatCode.Str, StatCode.Dex, true ),
            new SkillInfo(42, "Fencing", 4.5, 5.5, 0.0, "Fencer", null, 0.45, 0.55, 0.0, 0.25, StatCode.Dex, StatCode.Str, true ),
            new SkillInfo(43, "Wrestling", 9.0, 1.0, 0.0, "Wrestler", null, 0.9, 0.1, 0.0, 0.25, StatCode.Str, StatCode.Dex, true ),
